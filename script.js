    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "baduk imports משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'ae1fecd6-fe34-4403-98fc-eb788129154e',
                    name: data.name || '',
                    email: data.email || '',
